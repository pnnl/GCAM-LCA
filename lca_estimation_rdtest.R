...
query_out_all.proj <- c(query_out_c1p1.proj["h1r1b1n1c1p1"])

query_out_luc.proj <- loadProject("rgcam/query_out_luc.proj")

# in case project files picked up other scenario output
# query_out_c2p2.proj <- query_out_c2p2.proj[grepl("c2p2", names(query_out_c2p2.proj))]
# saveProject(query_out_c2p2.proj, file = "rgcam/query_out_c2p2.proj")
# query_out_luc.proj <- query_out_luc.proj[grepl("biofuel", names(query_out_luc.proj))]
# saveProject(query_out_luc.proj, "rgcam/query_out_luc.proj")
...
write_csv(fuels_lca_ghg, "outputs/fuels_lca_ghg_RD11.csv")
write_csv(fuels_primary_energy, "outputs/fuels_primary_energy_RD11.csv")
write_csv(fuels_prices, "outputs/tmp.csv")
